/* BASSMOD 2.1 C/C++ header file, copyright (c) 1999-2005 Ian Luck.
...
#define BASS_DEVICE_NOSYNC	16	// disable sync thread - syncs will be "mixtime"
...
DWORD BASSDEF(BASSMOD_MusicSetAttribute)(DWORD attrib, DWORD value);
DWORD BASSDEF(BASSMOD_MusicGetAttribute)(DWORD attrib);
